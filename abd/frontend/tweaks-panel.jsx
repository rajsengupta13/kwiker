...
function TweakColor({ label, value, options, onChange }) {
  if (!options || !options.length) {
    return (
      <div className="twk-row" style={{ flexDirection:"row", alignItems:"center", justifyContent:"space-between", gap:10 }}>
        <div className="twk-lbl"><span>{label}</span></div>
        <input type="color" style={{ appearance:"none", width:56, height:22, border:".5px solid rgba(0,0,0,.1)", borderRadius:6, padding:0, cursor:"pointer", background:"transparent" }}
